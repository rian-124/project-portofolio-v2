  ...
  return (
    <main>
      <section className="px-20">
        <div className="text-center font-mono font-bold text-5xl text-yellow-500 p-5">
          <h1>LETS CONNECT WITH ME 👋</h1>
        </div>
        <div className="w-full flex py-5 gap-10">
          <div className="w-1/2">
          ...
          <div className="w-1/2 self-center grid grid-cols-2 justify-center gap-5">
            <a
              href=""
              className="flex items-center w-60 h-16 gap-3 border border-b-8 border-black text-black p-3 rounded-xl bg-yellow-500 text-2xl"
            >
