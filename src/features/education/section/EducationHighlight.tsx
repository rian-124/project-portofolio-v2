...
import ScrollHeightAnimation from "~/components/providers/ScrollHeightAnimation";
      ...
      <div className="md:flex md:flex-row flex flex-col gap-5">
        <div className="space-y-5 md:w-[45%] w-full md:pr-10">
          <div className="flex justify-between gap-5">
            <ScrollHeightAnimation heightStart="350px" heightEnd="400px">
                <Image
            ...
            <ScrollHeightAnimation heightStart="400px" heightEnd="464px">
                <Image
            ...
            <div className="flex-col space-y-3">
              ...
              <ScrollHeightAnimation heightStart="450px" heightEnd="512px">
                <Image
