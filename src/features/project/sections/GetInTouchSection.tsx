  ...
  return (
    <section className="py-10">
      <div className="flex flex-col justify-center items-center md:text-5xl text-3xl  font-mono gap-2">
        ...
        <h1 className="flex items-center gap-3 text-yellow-500 font-bold">
          Get In Touch{" "}
          <MagneticEffect>
            <BiArrowFromLeft className="border rounded-full p-2 cursor-pointer md:w-16 md:h-16  w-10 h-10" />
          </MagneticEffect>
        </h1>
      </div>
    </section>
